...
class ReceiptsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create receipt" do
    assert_difference('Receipt.count') do
      post receipts_url, params: { receipt: { date: @receipt.date, store_id: @receipt.store_id } }
    end
  ...
  test "should update receipt" do
    patch receipt_url(@receipt), params: { receipt: { date: @receipt.date, store_id: @receipt.store_id } }
